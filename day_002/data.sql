-- 📘 Day 2: WHERE Clause, Logical Operators, and Filtering
-- --------------------------------------------------------
...
-- +----+--------------+-----+---------+-------------+------------+
-- | id | name         | age | salary  | department_id | hire_date  |
-- +----+--------------+-----+---------+-------------+------------+
-- | 1  | Alice Smith  | 28  | 55000   | 1           | 2019-05-21 |
-- | 2  | Bob Johnson  | 34  | 72000   | 2           | 2017-09-12 |
-- | 3  | Carol Davis  | 41  | 85000   | 1           | 2015-11-03 |
-- | 4  | Dan Wilson   | 29  | 48000   | 3           | 2021-01-18 |
-- | 5  | Eva Brown    | 25  | 60000   | 2           | 2022-06-14 |
-- | 6  | Frank Miller | 38  | 90000   | 4           | 2016-03-29 |
-- | 7  | Grace Lee    | 30  | 52000   | 3           | 2020-08-07 |
-- | 8  | Henry White  | 45  | 99000   | 4           | 2013-04-22 |
-- | 9  | Irene Black  | 26  | 58000   | 1           | 2023-02-10 |
-- | 10 | Jake Green   | 31  | 75000   | 2           | 2018-10-01 |
-- +----+--------------+-----+---------+-------------+------------+
...
-- 🔹 1. Basic Filtering with WHERE and Comparison Operators (=, !=, >, <, >=, <=)
-- ------------------------------------------------------------------------------
...
-- 🔹 5. Filtering with Multiple Conditions & Precedence
-- ----------------------------------------------------
